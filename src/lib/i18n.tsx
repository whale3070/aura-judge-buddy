...
const translations = {
  ...
  "submit.validateTrack": { zh: "请选择参赛赛道", en: "Please select a track" },
  "submit.trackLabel": { zh: "参赛赛道 *", en: "Track *" },
  "submit.trackPlaceholder": { zh: "— 请选择 —", en: "— Choose —" },
  "submit.trackHint": {
    zh: "由管理员在「赛道管理」中配置；排名按所选赛道分别统计。",
    en: "Tracks are configured in track management; rankings are scoped to the selected track.",
  },
  "submit.tracksLoading": { zh: "正在加载本场赛道…", en: "Loading tracks…" },
  ...
  "ranking.trackScopeNote": {
    zh: "当前列表仅包含所选赛道下的项目，不同赛道之间不作混合排名。",
    en: "This list only includes projects in the selected track; tracks are ranked separately.",
  },
  "ranking.trackTabLabel": {
    zh: "{label}（{n}）",
    en: "{label} ({n})",
  },
  "ranking.trackTotalInScope": {
    zh: "本赛道当前共有 {n} 条排名记录（与所选赛道口径一致；切换「规则筛选」后列表可能少于该数）。",
    en: "This track has {n} ranking row(s) (same scope as the track filter; the rule filter may show fewer).",
  },
  ...
  "ranking.radarSectionTitle5": { zh: "五维能力雷达图（0–20）", en: "Five-dimension radar (0–20)" },
  "ranking.radarSectionTitle4": { zh: "四维能力雷达图（0–10）", en: "Four-dimension radar (0–10)" },
  ...
  "ranking.radarFootnote5": {
    zh: "分数由评审正文中解析，多模型结果取算术平均；每维满分 20。离中心越远表示该维度越高。",
    en: "Scores are parsed from review text and averaged across models; each dimension is 0–20. Farther from the center means stronger on that dimension.",
  },
  "ranking.radarFootnote4": {
    zh: "分数由评审正文中解析，多模型结果取算术平均；每维满分 10。离中心越远表示该维度越高。",
    en: "Scores are parsed from review text and averaged across models; each dimension is 0–10. Farther from the center means stronger on that dimension.",
  },
  ...
  "admin.trackAssignTitle": { zh: "赛道归属（保存后计入该赛道排行）", en: "Track assignment (ranking filters by this track)" },
  "admin.trackUnassigned": { zh: "未指定", en: "Unassigned" },
  "admin.trackSave": { zh: "保存赛道", en: "Save track" },
  "admin.trackSaving": { zh: "保存中…", en: "Saving…" },
  "admin.trackSaved": { zh: "赛道已保存", en: "Track saved" },
  "admin.trackSaveError": { zh: "保存赛道失败", en: "Failed to save track" },
  "admin.trackAssignHint": {
    zh: "选项来自本场「赛道管理」。需项目已有排名数据（*_00_README.md 的裁决 JSON）才会出现在对应赛道榜单中。",
    en: "Options come from track management for this round. A ranking row must exist for the project to appear on that track’s leaderboard.",
  },
  "admin.trackNoConfigHint": {
    zh: "本场尚未配置赛道，请先在「赛道管理」添加后再分配。",
    en: "No tracks configured for this round. Add tracks in track management first.",
  },
  "admin.trackViewRanking": { zh: "查看该赛道排行 →", en: "Open track ranking →" },
  "admin.trackLegacyCurrent": { zh: "当前值", en: "current" },
  ...
  "admin.batchIngestTabRepos": { zh: "仓库列表", en: "Repositories" },
  "admin.batchIngestTabTrack": { zh: "赛道", en: "Track" },
  "admin.batchIngestTrackLabel": { zh: "导入到赛道", en: "Assign to track" },
  "admin.batchIngestTrackPlaceholder": { zh: "— 请选择赛道 —", en: "— Select track —" },
  "admin.batchIngestTrackRequired": { zh: "本场已配置赛道，请先在右侧「赛道」选项卡中选择赛道。", en: "This round has tracks configured. Pick a track under the Track tab." },
  "admin.batchIngestTrackHint": {
    zh: "批量创建的提交会写入该赛道；排行页按 ?track= 筛选即可查看。未配置赛道时可不选。",
    en: "Each ingested submission gets this track for ranking filters. Leave unset if the round has no tracks.",
  },
  "admin.batchIngestHelpTab": { zh: "说明", en: "About" },
  "admin.batchIngestHelpBody": {
    zh: "每行一个 GitHub 仓库 HTTPS 链接。任务在后台处理：拉取 README 写入 word，并按选项触发 LLM 裁决。勾选赛道后，结果会出现在对应赛道的提交列表与排行中。",
    en: "One HTTPS GitHub URL per line. Jobs run in the background (README → word, optional LLM). With a track selected, submissions appear under that track in admin and rankings.",
  },
  ...
  "rounds.gotoTracks": { zh: "赛道配置（本场）", en: "Tracks for this round" },
  "rounds.tracksTitle": { zh: "赛道管理", en: "Track management" },
  "rounds.tracksIntro": {
    zh: "配置本场的赛道 id 与展示名称，保存在服务器 submissions/<轮次>/.aura_tracks.json；排行与提交筛选会按赛道 id 使用。赛道 id 仅允许字母、数字、下划线与连字符，1–64 位。",
    en: "Configure track ids and labels for this round (stored as .aura_tracks.json under the round’s submissions folder). Rankings and filters use these ids. Track ids: letters, digits, underscore, hyphen; 1–64 chars.",
  },
  "rounds.tracksId": { zh: "赛道 ID", en: "Track ID" },
  "rounds.tracksName": { zh: "名称", en: "Name" },
  "rounds.tracksDesc": { zh: "说明（可选）", en: "Description (optional)" },
  "rounds.tracksPrize": { zh: "奖金池文案（可选）", en: "Prize pool text (optional)" },
  "rounds.tracksAdd": { zh: "添加赛道", en: "Add track" },
  "rounds.tracksRemove": { zh: "删除", en: "Remove" },
  "rounds.tracksSave": { zh: "保存", en: "Save" },
  "rounds.tracksSaved": { zh: "已保存赛道配置", en: "Tracks saved" },
  "rounds.tracksLoadError": { zh: "加载赛道配置失败", en: "Failed to load tracks" },
  "rounds.tracksSaveError": { zh: "保存失败", en: "Save failed" },
  "rounds.tracksErrEmptyId": { zh: "每条赛道需填写赛道 ID", en: "Each track needs an ID" },
  "rounds.tracksErrBadId": {
    zh: "赛道 ID 格式不合法（字母数字下划线连字符，1–64 位）",
    en: "Invalid track ID (use letters, digits, _ - ; 1–64 chars)",
  },
  "rounds.tracksErrDupId": { zh: "赛道 ID 不能重复", en: "Duplicate track ID" },
  "rounds.tracksErrEmptyName": { zh: "每条赛道需填写名称", en: "Each track needs a name" },
  "rounds.tracksEmptyHint": { zh: "尚未配置赛道，可点击「添加赛道」。保存空列表将清空该轮次的赛道配置。", en: "No tracks yet. Use “Add track”. Saving an empty list clears tracks for this round." },
